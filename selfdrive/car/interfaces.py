...
class CarInterfaceBase(ABC):
  ...
  def torque_from_lateral_accel_linear(self, lateral_accel_value: float, torque_params: car.CarParams.LateralTorqueTuning,
    ...
    return (lateral_accel_value / float(torque_params.latAccelFactor)) + friction - float(torque_params.latAccelOffset)
  ...
  @staticmethod
  def configure_torque_tune(candidate, tune, steering_angle_deadzone_deg=0.0, use_steering_angle=True, lat_accel_offset=0.0):
