...
from selfdrive.car.volkswagen import mqbcan, mqbevocan, pqcan
from selfdrive.car.volkswagen.values import CanBus, MQBEVO_CARS, PQ_CARS, CarControllerParams
...
class CarController:
  def __init__(self, dbc_name, CP, VM):
    ...
    if CP.carFingerprint in PQ_CARS:
      self.CCS = pqcan
    elif CP.carFingerprint in MQBEVO_CARS:
      self.CCS = mqbevocan
    else:
      self.CCS = mqbcan
