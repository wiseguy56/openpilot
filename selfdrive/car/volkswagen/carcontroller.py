...
class CarController:
  ...
  def update(self, CC, CS, ext_bus, now_nanos):
    ...
    if self.frame % self.CCP.ACC_CONTROL_STEP == 0 and self.CP.openpilotLongitudinalControl:
      ...
      can_sends.extend(self.CCS.create_acc_accel_control(self.packer_pt, CANBUS.pt, CS.acc_type,
                                                         CS.acc_coasting_supported, CC.longActive, accel,acc_control,
                                                         stopping, starting, CS.esp_hold_confirmation))
